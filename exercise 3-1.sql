...
(1, 'Steven Spielberg', 1234567890),
(2, 'Christopher Nolan', 9876543210),
(3, 'James Cameron', 5555555555),
(4, 'Quentin Tarantino', 4444444444),
(5, 'Patty Jenkins', 3333333333),
(6, 'Alfred Hitchcock', 2222222222);

-- Insert data into MOVIES table
INSERT INTO MOVIES (MOV_ID, MOV_TITLE, MOV_YEAR, MOV_LANG, DIR_ID) VALUES
(1, 'Avengers: Endgame', 2019, 'English', 1),
(2, 'Inception', 2010, 'English', 2),
(3, 'Titanic', 1997, 'English', 3),
(4, 'Pulp Fiction', 1994, 'English', 4),
(5, 'Wonder Woman', 2017, 'English', 5),
(6, 'Psycho', 1960, 'English', 6),
(7, 'Star Wars', 1977, 'English', 1),
(8, 'Blade Runner 2049', 2017, 'English', 1);
